...
If the migrate container exited non-zero, look at the log. Usually a Postgres TLS or auth issue. See [Deploy — Database SSL overview](/docs/deploy/database-ssl-overview).
...
- [Operate — Health Endpoints](/docs/operate/health-endpoints) — to identify which service is unhealthy.
