...
If you genuinely need more space than your VPS allows, time to migrate to managed Postgres (Neon, RDS, Cloud SQL). See [Cookbook — Managed Postgres (Neon)](/docs/cookbook/managed-postgres-neon).
