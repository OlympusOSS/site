...
1. **Soft delete**: state=inactive, grace period (see [grace-period-deletion](/docs/cookbook/data-compliance/grace-period-deletion)).
...
- [Cookbook, Audit anonymization](/docs/cookbook/defensive-security/audit-anonymization)
