...
You have the [SAML-OIDC bridge](/docs/cookbook/enterprise-sso/saml-oidc-bridge) running, or your SAML provider configured as an OIDC provider to Kratos.
...
SCIM endpoint in Athena: see [Cookbook, SCIM endpoint](/docs/cookbook/enterprise-sso/scim-endpoint).
...
- [Cookbook, SAML-OIDC bridge](/docs/cookbook/enterprise-sso/saml-oidc-bridge)
