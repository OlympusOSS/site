...
Build a SCIM endpoint. See [SCIM endpoint](/docs/cookbook/enterprise-sso/scim-endpoint).
...
This is non-trivial but doable. See [Per-tenant config](/docs/cookbook/multi-tenant/per-tenant-config).
