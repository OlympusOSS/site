...
Auth0's "adaptive MFA" uses ML to score risk. Olympus doesn't have built-in ML — you build risk-based rules via hooks. See [Cookbook — Risk-based auth](/docs/cookbook/risk-based-auth).
...
Rewrite each template. See [Cookbook — Custom email templates](/docs/cookbook/custom-email-templates).
...
See [Multi-tenant patterns](/docs/cookbook/multi-tenant-soft-isolation).
...
See [Compliance](/docs/security/compliance-soc2).
