...
See [Cookbook, Detect impossible travel](/docs/cookbook/defensive-security/detect-impossible-travel) for the full recipe.
...
- [Cookbook, Risk-based auth](/docs/cookbook/defensive-security/risk-based-auth)
