...
- [Cookbook, Email-aliases and plus-addressing](/docs/cookbook/auth-flows/email-aliases-and-plus-addressing)
...
- [Cookbook, Email domain claiming](/docs/cookbook/multi-tenant/email-domain-claiming)
