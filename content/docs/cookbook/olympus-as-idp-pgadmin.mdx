...
This recipe is built into Olympus — pgAdmin SSO via Olympus IAM is a default-on feature. See [Security — pgAdmin SSO](/docs/security/pgadmin-sso) for the full reference.
...
See [Security — pgAdmin DBA accounts](/docs/security/pgadmin-dba-accounts) for the canonical grants per role tier.
...
See [Operate — pgAdmin DBA offboarding](/docs/operate/pgadmin-dba-offboarding) for the full runbook.
