...
See [Admin impersonate user](/docs/cookbook/tools/admin-impersonate-user) for `act` claim.
...
- [Cookbook, M2M call from worker](/docs/cookbook/tokens-oauth2/m2m-call-from-worker)
