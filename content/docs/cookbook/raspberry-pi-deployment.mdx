...
Outbound-only tunnel — no port forwarding required. See [Cookbook — Cloudflare in front](/docs/cookbook/cloudflare-in-front).
...
- [Cookbook — Single VPS deployment](/docs/cookbook/single-vps-deployment) — similar principles, real VPS.
