...
See [Cookbook, Custom email templates](/docs/cookbook/ui-content/custom-email-templates). The Go templates can include `if eq .Identity.Traits.locale "es-ES"` branches.
