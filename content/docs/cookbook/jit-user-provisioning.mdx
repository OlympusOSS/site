...
- **Kratos webhook**: on `after.registration.password.hooks`, send your backend a webhook. Your backend provisions immediately. See [Cookbook — Custom Kratos webhook](/docs/cookbook/custom-kratos-webhook).
