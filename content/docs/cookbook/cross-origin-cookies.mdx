...
This is the cleanest. See [BFF whoami pattern](/docs/cookbook/whoami-bff).
...
- [Security — CSRF defense](/docs/security/csrf-defense)
- [Cookbook — BFF whoami pattern](/docs/cookbook/whoami-bff)
- [Cookbook — Iframe embed Hera](/docs/cookbook/iframe-embed-hera)
