...
For zero-downtime: expand/contract pattern (see [database migrations](/docs/operate/db-migrations)).
...
- [Cookbook — Migration rollback plan](/docs/cookbook/migration-rollback-plan)
