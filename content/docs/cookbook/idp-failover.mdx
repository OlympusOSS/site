...
Implement email magic-link as a default "I can't access my account" path. See [Cookbook — Email-only magic-link auth](/docs/cookbook/email-only-magic-link).
...
- [Cookbook — Email-only magic-link auth](/docs/cookbook/email-only-magic-link)
- [Cookbook — Recover lost encryption key](/docs/cookbook/recover-lost-encryption-key) — different but analogous DR pattern.
