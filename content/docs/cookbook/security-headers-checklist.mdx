...
XSS defense. See [CSP strict build](/docs/cookbook/csp-strict-build).
...
- [Security — Security headers](/docs/security/security-headers)
- [Security — CSP — Hera](/docs/security/csp-hera)
- [Security — CSP — Athena](/docs/security/csp-athena)
- [Security — XSS prevention](/docs/security/xss-prevention)
- [Cookbook — CSP strict build](/docs/cookbook/csp-strict-build)
