...
- Don't test brute-force against `admin@demo.user`. If you lock yourself out, see [Troubleshooting — Locked out of admin](/docs/troubleshooting/locked-out-of-admin).
