...
Common causes:
- Wrong RP ID (see [troubleshooting — passkey not prompted](/docs/troubleshooting/passkey-not-prompted)).
...
- [Cookbook — Account recovery questions](/docs/cookbook/account-recovery-questions)
