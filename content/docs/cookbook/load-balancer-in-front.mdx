...
If using Cloudflare for DNS and load balancing, the LB sits at Cloudflare's edge. Caddy still runs on your origin behind it. See [Cookbook — Cloudflare in front](/docs/cookbook/cloudflare-in-front).
