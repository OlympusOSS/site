...
For high-value accounts (admin, paying customer), make MFA required at signup. See [Feature flag MFA rollout](/docs/cookbook/feature-flag-mfa-rollout).
...
If a spray succeeded against any account, that account is compromised. Standard ATO response: see [Account takeover response](/docs/cookbook/account-takeover-response).
