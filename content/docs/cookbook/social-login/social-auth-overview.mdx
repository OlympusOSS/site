...
Customer X sees Okta-X button; Customer Y sees Okta-Y. Routed via [IdP discovery](/docs/cookbook/enterprise-sso/idp-discovery).

## SAML alternatives

Some enterprises prefer SAML over OIDC. Use a SAML-to-OIDC bridge (Dex, Keycloak) in front of Olympus.

See [SAML-OIDC bridge](/docs/cookbook/enterprise-sso/saml-oidc-bridge).
...
See [Account linking strategies](/docs/cookbook/auth-flows/account-linking-strategies).
...
- [Cookbook, Add social provider, Google](/docs/cookbook/social-login/add-social-provider-google)
- [Cookbook, Add social provider, Apple](/docs/cookbook/social-login/add-social-provider-apple)
- [Cookbook, Add social provider, Microsoft](/docs/cookbook/social-login/add-social-provider-microsoft)
- [Cookbook, Add social provider, GitHub](/docs/cookbook/social-login/add-social-provider-github)
