...
- Kratos's `email_verified` claim from Google is **not** trusted, Kratos runs its own verification flow on first link. See [Security, OIDC email_verified trust](/docs/security/identity-protection/oidc-email-verified-trust).
...
- [Cookbook, Add Apple as social provider](/docs/cookbook/social-login/add-social-provider-apple)
- [Cookbook, Add Microsoft as social provider](/docs/cookbook/social-login/add-social-provider-microsoft)
