...
The basic [Add social provider, Google](/docs/cookbook/social-login/add-social-provider-google) gets you running. For higher-assurance setups (enterprise, regulated industries), you'll want extra hardening.
...
See [Cookbook, Account linking strategies](/docs/cookbook/auth-flows/account-linking-strategies).
...
See [SCIM endpoint](/docs/cookbook/enterprise-sso/scim-endpoint).
...
- [Cookbook, SCIM endpoint](/docs/cookbook/enterprise-sso/scim-endpoint)
