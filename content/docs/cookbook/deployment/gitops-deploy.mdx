...
If you're on the K8s path ([Cookbook, Kubernetes deployment](/docs/cookbook/deployment/kubernetes-deployment)):
...
For ArgoCD itself authenticating users: use Olympus as the OIDC IdP, see [Cookbook, Use Olympus as IdP for ArgoCD](/docs/cookbook/tools/olympus-as-idp-argocd).
...
- [Cookbook, Kubernetes deployment](/docs/cookbook/deployment/kubernetes-deployment)
- [Cookbook, Use Olympus as IdP for ArgoCD](/docs/cookbook/tools/olympus-as-idp-argocd)
