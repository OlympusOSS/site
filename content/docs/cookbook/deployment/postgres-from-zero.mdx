...
For more concurrent apps: PgBouncer in front (see [PgBouncer](/docs/operate/db/postgres-pgbouncer)).
...
Daily cron. See [Backups - Postgres](/docs/operate/backups-recovery/backups-postgres).
...
See [read replicas](/docs/operate/db/read-replicas).
