...
Hydra and Kratos can use a write URL and read URL separately. Check the [Operate, Read replicas](/docs/operate/db/read-replicas) page for routing.
...
- [Cookbook, Cloudflare in front of Caddy](/docs/cookbook/deployment/cloudflare-in-front)
