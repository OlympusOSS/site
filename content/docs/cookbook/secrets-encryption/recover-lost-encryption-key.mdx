...
The blocklist (see [Security, Encryption key blocklist](/docs/security/encryption-keys/encryption-key-blocklist)) catches the most common "I set a weak key" mistake. It doesn't catch "I generated a strong key and lost it."
...
- [Operate, Encryption key rotation](/docs/operate/rotation/encryption-key-rotation), the proper rotation procedure.
