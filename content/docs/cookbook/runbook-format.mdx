...
Practice runbooks during chaos drills (see [chaos engineering](/docs/operate/chaos-engineering)). Find bugs when not stressed.
...
- [Cookbook — Timeline of incident](/docs/cookbook/timeline-of-incident)
