...
6. See [Account takeover response](/docs/cookbook/defensive-security/account-takeover-response).
...
Sometimes support needs to actually log in as the user to reproduce a bug. This is impersonation, see [Admin impersonate user](/docs/cookbook/tools/admin-impersonate-user).
...
- Security questions (only if you have them, see [recovery questions](/docs/cookbook/auth-flows/account-recovery-questions)).
- Video verification.
- Government ID.
