...
- Email matches existing password identity: link or reject? See [Account linking strategies](/docs/cookbook/account-linking-strategies).
...
- [Cookbook — SSO with Okta as IdP](/docs/cookbook/sso-with-okta-as-idp)
