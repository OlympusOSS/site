...
- [Cookbook — Use Olympus as OIDC IdP for Grafana](/docs/cookbook/olympus-as-idp-grafana) — parallel recipe.
- [Cookbook — Use Olympus as OIDC IdP for pgAdmin](/docs/cookbook/olympus-as-idp-pgadmin)
- [Security — pgAdmin DBA accounts](/docs/security/pgadmin-dba-accounts) — role-mapping pattern.
