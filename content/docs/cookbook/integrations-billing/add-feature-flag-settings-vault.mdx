...
Settings changes are audit-logged (see [Security, Brute-force](/docs/security/web-attacks/brute-force), same audit table). You can see who changed which flag when.
