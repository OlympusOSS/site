...
- [Cookbook — JIT user provisioning](/docs/cookbook/jit-user-provisioning) — alternative pattern.
- [Cookbook — Email-domain allowlist](/docs/cookbook/email-domain-allowlist) — open registration with restrictions.
