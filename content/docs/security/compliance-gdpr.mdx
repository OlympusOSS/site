...
| **Right to access (Art. 15)** | DSR export via [Cookbook — GDPR DSR Export](/docs/cookbook/gdpr-dsr-export). |
| **Right to erasure (Art. 17)** | [Cookbook — Self-service account deletion](/docs/cookbook/self-service-account-deletion). |
...
See [Operate — Audit log retention](/docs/operate/audit-log-retention).
...
Your incident playbook ([Operate — Incident response](/docs/operate/incident-response)) should include the breach-notification step.
