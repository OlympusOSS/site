...
[pgadmin-dba-accounts.md](/docs/security/infrastructure/pgadmin-dba-accounts). This registry is the SOC2 CC6.3 evidence
...
See [runbook-pgadmin-dba-offboarding.md](/docs/operate/administration/pgadmin-dba-offboarding) for the complete
procedure.
