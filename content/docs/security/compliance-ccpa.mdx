...
| --- | --- |
| **Right to know** | DSR export — see [Cookbook — GDPR DSR export](/docs/cookbook/gdpr-dsr-export). CCPA's "right to know" is similar in shape. |
| **Right to delete** | [Cookbook — Self-service account deletion](/docs/cookbook/self-service-account-deletion). |
...
- [Security — Compliance — GDPR](/docs/security/compliance-gdpr) — many overlapping concerns.
