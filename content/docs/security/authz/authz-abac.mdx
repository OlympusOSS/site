...
See [Security, Authorization, OPA integration](/docs/security/authz/authz-opa).
...
- [Security, Authorization, RBAC](/docs/security/authz/authz-rbac)
- [Security, Authorization, OPA integration](/docs/security/authz/authz-opa)
- [Security, Authorization, Cedar integration](/docs/security/authz/authz-cedar)
