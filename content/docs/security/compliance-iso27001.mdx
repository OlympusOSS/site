...
- Secrets audit cadence ([Operate](/docs/operate/secrets-audit)).
...
- [Security — Compliance — SOC 2](/docs/security/compliance-soc2) — similar shape.
- [Security — Compliance — GDPR](/docs/security/compliance-gdpr) — overlapping concerns.
