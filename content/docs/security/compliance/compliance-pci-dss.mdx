...
- Use tokenization (Stripe Customer + Subscription pattern, see [Cookbook, Stripe subscription gate](/docs/cookbook/integrations-billing/stripe-subscription-gate)).
...
| **10.7 Audit log retention** | 12 months min; configure per [Operate, Audit log retention](/docs/operate/monitoring/audit-log-retention). |
