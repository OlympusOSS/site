...
- Audit log retention: minimum **6 years** under HIPAA. Configure your retention accordingly, see [Operate, Audit log retention](/docs/operate/monitoring/audit-log-retention).
...
Your incident response playbook ([Operate](/docs/operate/backups-recovery/incident-response)) needs HIPAA-specific add-ons:
...
- [Security, Compliance, SOC 2](/docs/security/compliance/compliance-soc2), overlapping controls.
