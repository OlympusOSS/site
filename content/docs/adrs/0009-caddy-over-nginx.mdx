...
- Custom build needs a reproducible workflow: [`caddy-build.yml`](https://github.com/OlympusOSS/platform/blob/main/.github/workflows/caddy-build.yml) builds the image and publishes to GHCR. See [Security, Caddy Supply Chain](/docs/security/infrastructure/caddy-supply-chain).
