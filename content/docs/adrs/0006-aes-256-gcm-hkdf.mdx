...
Encryption format details in [Security, Encryption at Rest](/docs/security/encryption-keys/encryption-at-rest).
...
- Format version prefix `v2:` lets us migrate to a different scheme in the future without breaking existing records, see [Operate, Encryption Key Rotation](/docs/operate/rotation/encryption-key-rotation).
...
- [Security, Encryption at Rest](/docs/security/encryption-keys/encryption-at-rest), implementation details.
- [Security, Encryption Key Blocklist](/docs/security/encryption-keys/encryption-key-blocklist), known-weak values that are rejected.
- [Operate, Encryption Key Rotation](/docs/operate/rotation/encryption-key-rotation), runbook.
- [Internals, SDK encryption format](/docs/internals/sdk/sdk-encryption-format), version evolution.
