---
title: "/settings/totp"
description: "Hera page at /settings/totp"
---

# Hera page `/settings/totp`

Hera page at /settings/totp

**Source:** [`hera/src/app/settings/totp/page.tsx`](https://github.com/OlympusOSS/hera/blob/main/src/app/settings/totp/page.tsx)
