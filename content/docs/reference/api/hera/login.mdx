---
title: "/login"
description: "Renders the Kratos login flow + Hydra login challenge handler."
---

# Hera page `/login`

Renders the Kratos login flow + Hydra login challenge handler.

**Source:** [`hera/src/app/login/page.tsx`](https://github.com/OlympusOSS/hera/blob/main/src/app/login/page.tsx)
