...
description: "Hera page at /settings/sessions"
---

# Hera page `/settings/sessions`

Hera page at /settings/sessions

**Source:** [`hera/src/app/settings/sessions/page.tsx`](https://github.com/OlympusOSS/hera/blob/main/src/app/settings/sessions/page.tsx)
