---
title: "/settings"
description: "User settings — password, MFA, profile, social IdP linking."
---

# Hera page `/settings`

User settings — password, MFA, profile, social IdP linking.

**Source:** [`hera/src/app/settings/page.tsx`](https://github.com/OlympusOSS/hera/blob/main/src/app/settings/page.tsx)
