---
title: "/login/verify-device"
description: "Hera page at /login/verify-device"
---

# Hera page `/login/verify-device`

Hera page at /login/verify-device

**Source:** [`hera/src/app/login/verify-device/page.tsx`](https://github.com/OlympusOSS/hera/blob/main/src/app/login/verify-device/page.tsx)
