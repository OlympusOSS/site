---
title: "/registration"
description: "Renders the Kratos registration flow."
---

# Hera page `/registration`

Renders the Kratos registration flow.

**Source:** [`hera/src/app/registration/page.tsx`](https://github.com/OlympusOSS/hera/blob/main/src/app/registration/page.tsx)
