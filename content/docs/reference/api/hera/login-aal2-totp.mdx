---
title: "/login/aal2/totp"
description: "Hera page at /login/aal2/totp"
---

# Hera page `/login/aal2/totp`

Hera page at /login/aal2/totp

**Source:** [`hera/src/app/login/aal2/totp/page.tsx`](https://github.com/OlympusOSS/hera/blob/main/src/app/login/aal2/totp/page.tsx)
