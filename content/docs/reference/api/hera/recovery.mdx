---
title: "/recovery"
description: "Renders the Kratos recovery (password-reset) flow."
---

# Hera page `/recovery`

Renders the Kratos recovery (password-reset) flow.

**Source:** [`hera/src/app/recovery/page.tsx`](https://github.com/OlympusOSS/hera/blob/main/src/app/recovery/page.tsx)
