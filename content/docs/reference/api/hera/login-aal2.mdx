---
title: "/login/aal2"
description: "Hera page at /login/aal2"
---

# Hera page `/login/aal2`

Hera page at /login/aal2

**Source:** [`hera/src/app/login/aal2/page.tsx`](https://github.com/OlympusOSS/hera/blob/main/src/app/login/aal2/page.tsx)
