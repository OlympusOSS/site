...
description: "Hera page at /login/passwordless"
---

# Hera page `/login/passwordless`

Hera page at /login/passwordless

**Source:** [`hera/src/app/login/passwordless/page.tsx`](https://github.com/OlympusOSS/hera/blob/main/src/app/login/passwordless/page.tsx)
