---
title: "/verification"
description: "Renders the Kratos verification (email-confirm) flow."
---

# Hera page `/verification`

Renders the Kratos verification (email-confirm) flow.

**Source:** [`hera/src/app/verification/page.tsx`](https://github.com/OlympusOSS/hera/blob/main/src/app/verification/page.tsx)
