...
description: "Hera page at /reset-password"
---

# Hera page `/reset-password`

Hera page at /reset-password

**Source:** [`hera/src/app/reset-password/page.tsx`](https://github.com/OlympusOSS/hera/blob/main/src/app/reset-password/page.tsx)
