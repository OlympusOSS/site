---
title: "auth"
description: "Athena's own auth chain. Login via OAuth2 against IAM Hera; session cookie management."
---

# Feature: `auth`

Athena's own auth chain. Login via OAuth2 against IAM Hera; session cookie management.

**Source:** [`athena/src/features/auth/`](https://github.com/OlympusOSS/athena/tree/main/src/features/auth)
