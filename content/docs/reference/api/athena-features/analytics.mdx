---
title: "analytics"
description: "Dashboard analytics widgets — PKCE traffic, MFA stats, login attempts, lockout trends."
---

# Feature: `analytics`

Dashboard analytics widgets — PKCE traffic, MFA stats, login attempts, lockout trends.

**Source:** [`athena/src/features/analytics/`](https://github.com/OlympusOSS/athena/tree/main/src/features/analytics)
