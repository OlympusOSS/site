---
title: "messages"
description: "Kratos courier message log — verification emails, recovery emails, notification emails."
---

# Feature: `messages`

Kratos courier message log — verification emails, recovery emails, notification emails.

**Source:** [`athena/src/features/messages/`](https://github.com/OlympusOSS/athena/tree/main/src/features/messages)
