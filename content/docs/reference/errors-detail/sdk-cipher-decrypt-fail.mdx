...
See [Operate — Encryption key rotation](/docs/operate/encryption-key-rotation) or [Cookbook — Recover lost encryption key](/docs/cookbook/recover-lost-encryption-key).
