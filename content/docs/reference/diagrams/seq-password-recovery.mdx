...
Recovery via secondary channel (SMS, recovery codes, support escalation). See [Cookbook, Multi-factor recovery](/docs/cookbook/auth-flows/multi-factor-recovery).
