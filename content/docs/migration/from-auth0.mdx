...
| Custom domain | Caddy with your domain — see [Deploy — DNS and Domains](/docs/deploy/dns-and-domains) |
...
- [ ] Your apps can validate access tokens (see [Cookbook — Validate access token (Node)](/docs/cookbook/validate-token-node)).
