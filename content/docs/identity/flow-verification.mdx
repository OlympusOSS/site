...
In Olympus production, **verification is mandatory** before a user is considered fully active, see [Security, Email verification](/docs/security/identity-protection/email-verification) and the `verify-email-enforcement.yml` CI gate.
...
See [Security, OIDC email_verified trust](/docs/security/identity-protection/oidc-email-verified-trust) and [ADR 0011](/docs/adrs/0011-json-schema-identity).
