...
For OAuth2 access tokens (which are different — Hydra-issued), see [Integrate — Refresh tokens](/docs/integrate/oauth2-refresh-tokens).
...
Useful in incident response (see [Operate — Incident Response](/docs/operate/incident-response) for the mass-revocation playbook).
...
- [Operate — Incident Response](/docs/operate/incident-response) — mass session revocation.
