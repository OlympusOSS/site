...
5. Operators see the new image digest in dependabot PRs (or via the [Operate, Network Topology](/docs/operate/administration/network-topology) → "What's running?" inventory) and bump their compose.
6. Redeploy.
