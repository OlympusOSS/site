...
For first-party clients with `metadata.skip_consent = true`, Hera auto-accepts without rendering, see [Cookbook, Brand consent screen](/docs/cookbook/ui-content/brand-consent-screen).
...
These appear in Hera's stdout, picked up by your log shipper. See [Operate, Logs and observability](/docs/operate/monitoring/logs-and-observability).

## Related

- [Internals, Hera, Kratos integration](/docs/internals/hera/hera-kratos-integration)
