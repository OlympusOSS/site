...
The buffer is sanitized before return, see [Internals, Daedalus Secrets Sanitizer](/docs/internals/daedalus/daedalus-secrets-sanitizer) for the regex patterns that scrub bearer tokens, API keys, and DSN passwords from the output.
...
- [Integrate, MCP with Daedalus](/docs/integrate/platforms/mcp-with-daedalus), driving Daedalus from an MCP client.
- [Internals, Daedalus secrets sanitizer](/docs/internals/daedalus/daedalus-secrets-sanitizer).
