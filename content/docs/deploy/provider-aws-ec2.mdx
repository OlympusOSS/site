...
AWS isn't natively supported by Daedalus. Use [Direct SSH](/docs/deploy/provider-direct-ssh).
...
3. Use the SMTP credentials in Kratos courier config — see [Deploy — Email — Custom SMTP](/docs/deploy/email-custom-smtp).
...
- [Deploy — Email — Custom SMTP](/docs/deploy/email-custom-smtp)
- [Cookbook — Use Olympus as IdP for AWS IAM Identity Center](/docs/cookbook/olympus-as-idp-aws)
