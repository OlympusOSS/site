...
When you update DNS records, allow up to **48 hours** for full propagation (most updates are <1 hour but some resolvers cache for the TTL of the previous record). For a quick test:
