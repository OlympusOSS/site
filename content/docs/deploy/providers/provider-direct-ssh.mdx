...
- You'd rather Daedalus provision things, use [DigitalOcean](/docs/deploy/providers/provider-digitalocean) or [Hostinger](/docs/deploy/providers/provider-hostinger).
...
- [Operate, Network Topology](/docs/operate/administration/network-topology), what ports must be reachable.
