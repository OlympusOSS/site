...
GCP isn't natively supported by Daedalus. Use the [Direct SSH](/docs/deploy/providers/provider-direct-ssh) path or the manual deploy.
...
Configure `verify-full` SSL, see [Deploy, Database SSL verify-full](/docs/deploy/database/database-ssl-verify-full).
