...
Production secrets are sourced from GitHub Actions Secrets via `deploy.yml`. See [secrets-audit.md](/docs/operate/monitoring/secrets-audit) for the full production secret inventory.
