...
But **note:** Olympus's [CIAM/IAM isolation](/docs/security/infrastructure/ciam-iam-isolation) wants different cookie domains for CIAM and IAM. The correct config is:
