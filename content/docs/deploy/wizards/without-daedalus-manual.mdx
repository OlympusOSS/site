...
The full step-by-step is in [First production deploy](/docs/deploy/production/first-production-deploy). This page focuses on the deviations.
...
See [Security, Secrets Management](/docs/security/encryption-keys/secrets-management) for the full catalog.
...
The post-deploy checklist from [First production deploy](/docs/deploy/production/first-production-deploy), health endpoints, registration flow, recovery flow, OAuth2 client, applies regardless of how you got there.

## Where next

- [Deploy, First production deploy](/docs/deploy/production/first-production-deploy), the canonical step-by-step.
