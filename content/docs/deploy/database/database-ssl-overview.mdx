...
Certificate expiry: see [database-ssl-verify-full.md](/docs/deploy/database/database-ssl-verify-full) for current cert validity details (updated in platform#53).
...
[database-ssl-verify-full.md](/docs/deploy/database/database-ssl-verify-full) for the full configuration,
