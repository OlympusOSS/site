...
Changes to the platform repo trigger production deploys via `deploy.yml`. See [Internals — Deploy Pipeline](/docs/internals/platform-deploy-pipeline).
...
See [Internals — Athena Route Map](/docs/internals/athena-route-map).
...
See [Internals — Hera Route Map](/docs/internals/hera-route-map).
...
See [Reference — SDK Settings API](/docs/reference/api-sdk-settings) and [Internals — SDK Modules](/docs/internals/sdk-modules).
...
See [Internals — Octl Stack Bundle](/docs/internals/octl-stack-bundle).
...
See [Internals — Daedalus MCP Server](/docs/internals/daedalus-mcp-server) and [ADR 0022 — MCP Localhost Only](/docs/adrs/0022-mcp-localhost-only).
