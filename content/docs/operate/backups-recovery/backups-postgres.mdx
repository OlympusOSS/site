...
- Caddy ACME state and certificates. See [Operate, Backups (Caddy data)](/docs/operate/backups-recovery/backups-caddy-data).
- Container images. These come from GHCR by digest.
- The compose configs. These are in your platform Git fork.

## Related

- [Operate, Backups (Caddy data)](/docs/operate/backups-recovery/backups-caddy-data)
