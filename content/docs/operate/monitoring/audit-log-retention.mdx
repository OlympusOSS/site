...
- [Security, Brute-force protection](/docs/security/web-attacks/brute-force), the audit event source.
- [Operate, Logs and observability](/docs/operate/monitoring/logs-and-observability), broader logging.
