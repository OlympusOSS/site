...
Daedalus embeds an MCP server on `127.0.0.1:14210`. This means Claude can drive the wizard the same way you can. See [Integrate — MCP with Daedalus](/docs/integrate/mcp-with-daedalus) and [ADR 0022 — MCP Localhost Only](/docs/adrs/0022-mcp-localhost-only).

## Where next

- [Deploy — overview](/docs/deploy/overview) — full deploy section, including non-Daedalus paths.
- [Deploy — with the Daedalus wizard](/docs/deploy/with-daedalus-wizard) — page-by-page wizard reference.
