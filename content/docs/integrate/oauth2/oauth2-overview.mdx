...
| --- | --- | --- |
| Server-side web app (you control the server, can keep a secret) | Authorization Code | [Authorization Code](/docs/integrate/oauth2/oauth2-authorization-code) |
| Single-page app (SPA), mobile app, CLI, anywhere a secret can't be kept | Authorization Code + **PKCE** | [PKCE](/docs/integrate/oauth2/oauth2-pkce) |
| Backend service calling another backend service (no human user involved) | Client Credentials | [Client Credentials](/docs/integrate/oauth2/oauth2-client-credentials) |
| Renewing a token without sending the user through login again | Refresh Token | [Refresh Tokens](/docs/integrate/oauth2/oauth2-refresh-tokens) |
| Discovering Olympus's OAuth2 endpoints programmatically | OIDC Discovery | [OIDC Discovery](/docs/integrate/oauth2/oidc-discovery) |
| Getting profile data after login | OIDC `userinfo` | [OIDC userinfo](/docs/integrate/oauth2/oidc-userinfo) |
| Logging the user out of both your app and Olympus | RP-initiated logout | [RP-initiated logout](/docs/integrate/oauth2/logout-rp-initiated) |
...
Olympus **enforces PKCE for all public clients**. There is no way to disable this, see [Security, PKCE Enforcement](/docs/security/identity-protection/pkce-enforcement) and [ADR 0019](/docs/adrs/0019-pkce-mandatory-public-clients).
...
- [OAuth2 error codes](/docs/integrate/oauth2/oauth2-error-codes), full catalog.
- [Troubleshooting, OAuth2 invalid_grant](/docs/troubleshooting/oauth2-issues/oauth2-invalid-grant)
- [Troubleshooting, OAuth2 pkce_required](/docs/troubleshooting/oauth2-issues/oauth2-pkce-required)

## Where next

- [Authorization Code](/docs/integrate/oauth2/oauth2-authorization-code), most common flow.
- [PKCE](/docs/integrate/oauth2/oauth2-pkce), for SPAs, mobile, CLIs.
