...
For JWT access tokens, use `jsonwebtoken` with JWKS — see [Cookbook — Validate access token (Rust)](/docs/cookbook/validate-token-rust).

## Related

- [Cookbook — Validate access token (Rust)](/docs/cookbook/validate-token-rust)
