...
Screenshots and terminal output flow through a [secrets sanitizer](/docs/internals/daedalus-secrets-sanitizer) that redacts Bearer tokens, API keys, and DSN passwords. The redaction is best-effort, not exhaustive.
...
- [Internals — Daedalus MCP server](/docs/internals/daedalus-mcp-server) — implementation details.
