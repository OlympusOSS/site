...
For Shopify Plus, admin SSO uses SAML, Olympus is OIDC-first. Bridge with a SAML→OIDC translator (see [Cookbook, SAML OIDC bridge](/docs/cookbook/enterprise-sso/saml-oidc-bridge)).
