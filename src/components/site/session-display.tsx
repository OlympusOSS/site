			...
			<Card>
				...
				<AnimatePresence>
					{showClaims && (
						...
						>
							<pre className="mx-4 mb-4 overflow-auto rounded-lg bg-muted p-4 text-[11px] leading-relaxed text-foreground">
				...
				<CardContent className="p-4">
					...
					<div className="space-y-2">
						<div className="flex items-center justify-between">
							...
							<button
								type="button"
								onClick={() => copyToClipboard(data.access_token, "access")}
