...
const GENERATORS = [
	{
		name: "OpenAPI → Hydra",
		cmd: ["bun", "run", "scripts/gen/openapi-to-mdx.mjs", "../athena/openapi.json", "content/docs/reference/api/hydra", "hydra"],
	},
	{
		name: "OpenAPI → Kratos",
		cmd: ["bun", "run", "scripts/gen/openapi-to-mdx.mjs", "scripts/gen/specs/kratos-api.json", "content/docs/reference/api/kratos", "kratos"],
	},
